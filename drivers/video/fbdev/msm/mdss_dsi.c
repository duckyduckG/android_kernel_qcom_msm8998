...
#endif
//SW4-HL-Display-GlanceMode-00+}_20170524
#include "../../boost/boost_nt50356.h" //B2N
#endif
...
//SW4-HL-Display-GlanceMode-00*{_20170524
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_AOD_FEATURE)
...
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_LINK_READY <-- start\n", __func__);
#endif
...
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_LINK_READY <-- end\n", __func__);
#endif
		break;
...
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_UNBLANK <-- end\n", __func__);
#endif
		break;
	case MDSS_EVENT_POST_PANEL_ON:
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_POST_PANEL_ON <-- start\n", __func__);
#endif
		rc = mdss_dsi_post_panel_on(pdata);
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_POST_PANEL_ON <-- end\n", __func__);
#endif
		break;
	case MDSS_EVENT_PANEL_ON:
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_PANEL_ON <-- start\n", __func__);
#endif
...
#endif
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_PANEL_ON <-- end\n", __func__);
#endif
		break;
...
#endif
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_BLANK <-- start\n", __func__);
#endif
		power_state = (int) (unsigned long) arg;
		if (ctrl_pdata->off_cmds.link_state == DSI_HS_MODE)
			rc = mdss_dsi_blank(pdata, power_state);
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_BLANK <-- end\n", __func__);
#endif
		break;
	case MDSS_EVENT_PANEL_OFF:
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_PANEL_OFF <-- start\n", __func__);
#endif
		power_state = (int) (unsigned long) arg;
		ctrl_pdata->ctrl_state &= ~CTRL_STATE_MDP_ACTIVE;
...
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_PANEL_OFF <-- end\n", __func__);
#endif
		break;
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS)
...
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_DISABLE_PANEL <-- start\n", __func__);
#endif
		/* disable esd thread */
		disable_esd_thread();
...
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_DISABLE_PANEL <-- end\n", __func__);
#endif
		break;
...
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_DSI_UPDATE_PANEL_DATA<-- start\n", __func__);
#endif
		rc = mdss_dsi_update_panel_config(ctrl_pdata,
					(int)(unsigned long) arg);
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_DSI_UPDATE_PANEL_DATA<-- end\n", __func__);
#endif
		break;
...
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_REGISTER_MDP_CALLBACK<-- start\n", __func__);
#endif
		rc = mdss_dsi_register_mdp_callback(ctrl_pdata,
			(struct mdss_intf_recovery *)arg);
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_REGISTER_MDP_CALLBACK<-- end\n", __func__);
#endif
		break;
...
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_DSI_DYNAMIC_SWITCH<-- start\n", __func__);
#endif
		mode = (u32)(unsigned long) arg;
		mdss_dsi_switch_mode(pdata, mode);
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_DSI_DYNAMIC_SWITCH<-- end\n", __func__);
#endif
		break;
	case MDSS_EVENT_DSI_RECONFIG_CMD:
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_DSI_RECONFIG_CMD<-- start\n", __func__);
#endif
		mode = (u32)(unsigned long) arg;
		rc = mdss_dsi_reconfig(pdata, mode);
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) && defined(CONFIG_FIH_DEBUG)
		pr_warn("[HL]%s: MDSS_EVENT_DSI_RECONFIG_CMD<-- end\n", __func__);
#endif
		break;
